import { useWarrantyPolicies } from "@/hooks/policies/warrantyPolicies/useWarrantyPolicies";
import Spinner from "@/components/ui/Spinner";
import Table from "@/components/ui/Table";
import Menus from "@/components/ui/Menus";
import WarrantyPolicyRow from "./WarrantyPolicyRow";

function WarrantyPolicyTable() {
  const { isLoading, policies } = useWarrantyPolicies();
    ...
    <Menus>
      <Table columns="1fr 1fr 1fr 1fr 2fr">
        ...
        <Table.Body
          data={policies}
          render={(policy) => (
            <WarrantyPolicyRow key={policy.id} policy={policy} />
          )}
        />
      </Table>
    </Menus>
