...
import { useCreateCheckProductPolicy } from "@/hooks/policies/checkProductPolicies/useCreateCheckProductPolicy";
...
function AddCheckProductPolicy() {
  const moveBack = useMoveBack();
  const { handleSubmit } = useForm();
  const { isLoading, createPolicy } = useCreateCheckProductPolicy();
  ...
  return (
    <>
      <Row type="horizontal">
        <Heading as="h1">Thêm chính sách kiểm hàng</Heading>
...
export default AddCheckProductPolicy;
