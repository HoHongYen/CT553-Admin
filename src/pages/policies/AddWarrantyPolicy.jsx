...
import { useCreateWarrantyPolicy } from "@/hooks/policies/warrantyPolicies/useCreateWarrantyPolicy";

function AddWarrantyPolicy() {
  const moveBack = useMoveBack();
  const { handleSubmit } = useForm();
  const { isLoading, createPolicy } = useCreateWarrantyPolicy();
  ...
  return (
    <>
      <Row type="horizontal">
        <Heading as="h1">Thêm chính sách bảo hành</Heading>
