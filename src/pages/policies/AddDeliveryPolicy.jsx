...
import { useCreateDeliveryPolicy } from "@/hooks/policies/deliveryPolicies/useCreateDeliveryPolicy";
...
function AddDeliveryPolicy() {
  ...
  const { isLoading, createPolicy } = useCreateDeliveryPolicy();
  ...
  return (
    <>
      <Row type="horizontal">
        <Heading as="h1">Thêm chính sách giao hàng</Heading>
...
export default AddDeliveryPolicy;
