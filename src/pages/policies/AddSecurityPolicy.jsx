...
import { useCreateSecurityPolicy } from "@/hooks/policies/securityPolicies/useCreateSecurityPolicy";
...
function AddSecurityPolicy() {
  const moveBack = useMoveBack();
  const { handleSubmit } = useForm();
  const { isLoading, createPolicy } = useCreateSecurityPolicy();
  ...
  return (
    <>
      <Row type="horizontal">
        <Heading as="h1">Thêm chính sách bảo mật</Heading>
