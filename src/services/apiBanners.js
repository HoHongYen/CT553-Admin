...
export async function getBanners({ bannerSearch, bannerCategoryId, visible, sortBy, page, limit }) {
    const banners = (await api.get("/admin", { params: { bannerSearch, bannerCategoryId, visible, sortBy, page, limit } })).data;
